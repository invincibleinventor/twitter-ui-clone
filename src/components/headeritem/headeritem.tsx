...
export default component$((props:pros)=>{
    ...
    return(
        <Link href={link} class="flex flex-row rounded-full px-[14px] pr-8 w-max py-[10px] space-x-[16px] rounded-full transition-all ease-linear duration-100 cursor-pointer hover:bg-gray-200 items-center content-center">
